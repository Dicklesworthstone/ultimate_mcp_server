...
class CompletionRequest(BaseModel):
    ...
    provider: Optional[str] = Field(default=None, description="Provider name (inferred from model if not specified)")
    ...
    messages: Optional[List[Dict[str, Any]]] = Field(default=None, description="Message history for chat models")
